...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    'IStreamline:minimizeWindow2': typeof import('~icons/streamline/minimize-window2')['default']
    IStreamlineMinimizeWindow2: typeof import('~icons/streamline/minimize-window2')['default']
